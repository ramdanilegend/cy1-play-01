...
function TableView(props) {
  ...
  const data = dashboardContext.state.dashboardView.dashboardNightLocation;
  // const [datas, setDatas] = React.useState([]);
  // React.useEffect(() => {
  //   if (dashboardContext.state.dashboardView.dashboardNightLocation) {
  //     setDatas(dashboardContext.state.dashboardView.dashboardNightLocation);
  //     setError(false);
  //   }
  // }, []);
